...
urlpatterns = [
    ...
    path('Descargar_copia_de_seguridad/', CopiaDeSeguridad.descargar_backup, name='Descargar-SQLite3'),
    path('Importar_SQLite3_A_Mysql/', CopiaAMysql.import_data, name='SQLite3-A-Mysql'),
    ...
    path('Movimiento-Permisos/', views.TablaPermisosAsignaElimina, name='T-PermisoAsignadosEliminados'),
    ...
    path('Formulario-Estatus/', formularioSubTabla.formularioEstatus, name='F-Estatus'),
    path('Formulario-Tipo-Material/', formularioSubTabla.formularioTipoMaterial, name='F-Tipo-Material'),
    path('Formulario-Tipo-Movimiento/', formularioSubTabla.formularioTipoMovimiento, name='F-Tipo-Movimiento'),
    path('Formulario-Tipo-Presentacion/', formularioSubTabla.formularioTipoPresentacion, name='F-Tipo-Presentacion'),
    path('Formulario-Unidad-Medida/', formularioSubTabla.formularioUnidadMedida, name='F-Unidad-Medida'),

    # FORMULARIO DE CATALOGOS
    path('Formulario-Cliente/', formularioCatalogos.FormualrioClientes, name='F-Cliente'),
    path('Formulario-Proveedor/', formularioCatalogos.FormualrioProveedores, name='F-Proveedor'),
    path('Formulario-Operador/', formularioCatalogos.FormualrioOperadores, name='F-Operador'),
    path('Formulario-Materia-Prima/', formularioCatalogos.FormualrioMateriasPrimas, name='F-MateriaPrima'),
    path('Formulario-Producto/', formularioCatalogos.FormualrioProductos, name='F-Producto'),
    path('Formulario-Corral/', formularioCatalogos.FormualrioCorrales, name='F-Corral'),
    path('Formulario-Tipo-Animal/', formularioCatalogos.FormualrioTipoAnimaless, name='F-TipoAnimal'),
    path('Formulario-Contenedor-Materia-Prima/', formularioCatalogos.FormualrioContnendoresMateriasPrimas, name='F-ContenedorMP'),
    path('Formulario-Contenedor-Producto/', formularioCatalogos.FormualrioContenedoresProductos, name='F-ContenedorProducto'),
    path('Formulario-Tolva/', formularioCatalogos.FormualrioTolva, name='F-Tolva'),

    # FORMULARIO DE PROCESOS
    path('Formulario-Entrada-Materia-Prima/', formularioProcesos.FormularioEntradaMateriasPrimas, name='F-Ent-Materia-Prima'),
    path('Formulario-Salida-Materia-Prima/', formularioProcesos.FormularioSalidaMateriasPrimas, name='F-Sal-Materia-Prima'),
    path('Formulario-Entrada-Producto/', formularioProcesos.FormularioEntradaProductos, name='F-Ent-Productos'),
    path('Formulario-Salida-Producto/', formularioProcesos.FormularioSalidaProductos, name='F-Sal-Productos'),
    path('Formulario-Movimientos-En-Animales/', formularioProcesos.FormularioMovimientoInterno, name='F-Mov-Interno'),
    path('Formulario-Movimientos-Animales/', formularioProcesos.FormularioMovimientoAnimales, name='F-MovAnimales'),
    path('Formulario-Detalles-Animales/', formularioProcesos.FormularioDetallesAnimales, name='F-DetallesAnimales'),
    path('Formulario-Solicitud-Servido/', formularioProcesos.FormularioSolicitudServido, name='F-Solicitud-Servidos'),
    path('Formulario-Servidos-Manuales/', formularioProcesos.FormularioServidoAnimales, name='F-Servidos'),
    path('Formulario-Inventario-Materia-Prima/', formularioProcesos.FormularioInventarioMateriaPrima, name="F-InventarioMP"),
    path('Formulario-Inventario-Productos/', formularioProcesos.FormularioInventarioProducto, name="F-InventarioProductos"),

    # FORMULARIO DE OPERADORES
    path('Dato-Operador-Entrada-Productos/Agregar/<str:ID>',formularioProcesos.FormularioOperadoresEntradaProductos, name="A-Operaror-Entrada-Producto"),
    path('Dato-Operador-Salida-Productos/Agregar/<str:ID>',formularioProcesos.FormularioOperadoresSalidaProductos, name="A-Operaror-Salida-Producto"),
    path('Dato-Operador-Entrada-Materias-Primas/Agregar/<str:ID>',formularioProcesos.FormularioOperadorEntradaMateriaPrima, name="A-Operaror-Entrada-Materia"),
    path('Dato-Operador-Salida-Materias-Primas/Agregar/<str:ID>',formularioProcesos.FormularioOperadorSalidaMateriaPrima, name="A-Operaror-Salida-Materia"),

    # SUBTABLA
    path('SubTabla-Estatus/', mostrarSubTabla.TablaEstatus, name='T-Estatus'),
    path('SubTabla-Tipo-Material/',mostrarSubTabla.TablaTipoMaterial, name='T-Tipo-Material'),
    path('SubTabla-Tipo-Movimiento/',mostrarSubTabla.TablaTipoMovimiento, name='T-Tipo-Movimiento'),
    path('SubTabla-Tipo-Presentacion/',mostrarSubTabla.TablaTipoPresentacion, name='T-Tipo-Presentacion'),
    path('SubTabla-Unidad-Medida/',mostrarSubTabla.TablaUnidadMedida, name='T-Unidad-Medida'),
    ...
    path('Dato-Materia-Prima/', mostrarCatalogos.TablaMateriasPrimas,name='T-MateriaPrima'),
    path('Dato-Producto/', mostrarCatalogos.TablaProductos, name='T-Producto'),
    path('Dato-Producto/Agregar/<ID>',mostrarCatalogos.AgregarRecetas, name='A-Producto'),
    path('Dato-Producto/Detalle/<str:ID>',mostrarCatalogos.detalleRecetas, name='D-Producto'),
    ...
    path('Dato-Contenedor-Materia-Prima/',mostrarCatalogos.TablaContenedoresMateriasPrimas, name='T-ContenedorMP'),
    path('Dato-Contenedor-Producto/',mostrarCatalogos.TablaContenedoresProductos, name='T-ContenedorProducto'),
    path('Dato-Tolva/', mostrarCatalogos.TablaTolva, name='T-Tolva'),

    # TABLA DE PROCESOS
    path('Dato-Entrada-Materia-Prima/', mostrarProcesos.TablaEntradaMateriasPrimas, name='T-Ent-Materia-Prima'),
    path('Dato-Salida-Materia-Prima/', mostrarProcesos.TablaSalidaMateriasPrimas, name='T-Sal-Materia-Prima'),
    path('Dato-Entrada-Producto/', mostrarProcesos.TablaEntradaProductos, name='T-Ent-Productos'),
    path('Dato-Salida-Producto/', mostrarProcesos.TablaSalidaProductos, name='T-Sal-Productos'),
    path('Dato-Movimientos-Animales/', mostrarProcesos.TablaMovimientoAnimales, name='T-MovAnimales'),        
    path('Dato-Movimientos-Animales/Agregar/<ID>', mostrarProcesos.AgregarMovimientoAnimales, name='A-MovAnimales'),
    path('Dato-Movimientos-Animales/Detalle/<str:ID>', mostrarProcesos.detalleAnimales, name='D-MovAnimales'),
    path('Dato-Detalles-Animales/', mostrarProcesos.TablaDetallesAnimales, name='T-DetallesAnimales'),
    path('Dato-Historial/',mostrarProcesos.TablaHistorialAsignacionCorral, name='T-Historial'),
    path('Dato-Inventario-Materia-Prima/',mostrarProcesos.TablaInventarioMateriaPrima, name="T-InventarioMP"),
    path('Dato-Inventario-Productos/',mostrarProcesos.TablaInventarioProducto, name="T-InventarioProductos"),

    # DATOS DEL AREA DE SERVIDOS
    path('Dato-Solicitud-Servidos/', mostrarProcesos.TablaSolicitudServido, name='T-Solicitud-Servidos'),
    path('Dato-Corrales-Servidos/', mostrarProcesos.TablaServidoCorral, name='T-Corrales-Servidos'),
    path('Dato-Consolidacion-Servido/', mostrarProcesos.TablaConsolidacionServido, name='T-Consolidacion'),
    path('Dato-Consolidacion-Servido/Filtro/Tolva/<str:ID>/<int:Estatus>/<int:Producto>/', mostrarProcesos.TablaTolvaServido),
    path('Dato-Consolidacion-Servido-Filtro/', mostrarProcesos.TablaFiltroServido, name='FT-Consolidacion'),
    path('Dato-Tolva-Servido/', mostrarProcesos.TablaTolva, name='T-Tolva-Servido'),
    path('Dato-Tolva-Servido-Se-Sirve/', mostrarProcesos.TablaTolvaServidoCorral, name='T-Se-Sirve'),
    path('Dato-Servidos-Manuales/', mostrarProcesos.TablaServidoAnimales, name='T-Servidos'),

    # DATOS DE LOS DATOS DE LA TOLVA
    path('Dato-Cargamento-Tolva/', mostrarProcesos.TablaCargamentoTolva, name='T-Cargamento-Tolva'),
    
    # DETALLES DE OPERADORES
    path('Dato-Operador-Entrada-Productos/', mostrarProcesos.TablaOperadoresEntradaProductos),
    path('Dato-Operador-Salida-Productos/', mostrarProcesos.TablaOperadoresSalidaProductos, name="E-Operador-Producto"),
    path('Dato-Operador-Entrada-Materias-Primas/', mostrarProcesos.TablaOperadoresEntradaMateriasPrimas),
    path('Dato-Operador-Salida-Materias-Primas/', mostrarProcesos.TablaOperadoresSalidasMateriasPrimas),
    ...
    path('Guardar-Movimiento-Interno-De-Amimales/',
         guardarProcesos.guardarMovimientosInterno),
    ...
    path('actualizarRecetasProductos/',actualizarCatalogos.actualizarRecetasProductos),
    ...
    path('ActualizarContenedorProducto/',actualizarCatalogos.actualizarContenedoresProductos),
    ...
    path('ActualizarEntradaMateriasPrimas/', actualizarProcesos.actualizarEntradaMateriaPrima),
    path('ActualizarSalidaMateriasPrimas/', actualizarProcesos.actualizarSalidaMateriaPrima),
    path('ActualizarEntradaProductos/', actualizarProcesos.actualizarEntradaProductos),
    path('ActualizarSalidaProductos/', actualizarProcesos.actualizarSalidaProductos),
    path('ActualizarCantidadMovimientosAnimales/', actualizarProcesos.actualizarCantidadAnimales),
    path('ActualizarMovimientosAnimales/', actualizarProcesos.actualizarMovimientosAniamales),
    path('ActualizarInventatioInicialMateriaPrima/', actualizarProcesos.actualizarInventatioInicialMateriaPrima),
    path('ActualizarInventatioInicialProducto/', actualizarProcesos.actualizarInventatioInicialProducto),
    path('ActualizarServidosATolva/', actualizarProcesos.actualizarServidosATolva),

    # ACTUALIZAR OPRADORES PROCESOS
    path('ActualizarOperadoresEntradaProducto/', actualizarProcesos.actualizarOperadoresEntradaProducto),
    path('ActualizarOperadoresSalidaProducto/', actualizarProcesos.actualizarOperadoresSalidaProducto),
    path('ActualizarOperadoresEntradaMateriaPrima/', actualizarProcesos.actualizarOperadoresEntradaMateriasPrimas),
    path('ActualizarOperadoresSalidaMateriaPrima/', actualizarProcesos.actualizarOperadoresSalidaMateriasPrimas),
    path('ActualizarCancelarServidosVehiculos/', actualizarProcesos.actualizarCancelarTolva),
    # REPORTES
    # bascula
    path('Reporte-Movimientos-Entrada-Materia-Prima/', reportes.reporteMovEntradaMP, name='Reportes-Entrada-Materia-Prima'),
    path('Reporte-Movimientos-Salida-Materia-Prima/', reportes.reporteMovSalidaMP, name='Reportes-Salida-Materia-Prima'),
    # animales nuevos
    path('Reporte-Movimientos-Animales/', reportes.reporteAnimalesMovimientos, name='Reportes-Movimientos-Animales'),
    # animales
#     path('Reporte-Movimientos-Animales/', reportes.reporteAnimalesMovimientos,
#          name='Reportes-Movimientos-Animales'),
    path('Reporte-Animales-Clientes/', reportes.reportePorClientes, name='Reportes-Animales-Clientes'),
    path('Reporte-Animales-Clientes-Corrales/', reportes.reportePorClientesCorrales, name='Reportes-Animales-Clientes-Corrales'),
    path('Reporte-Por-Animales/', reportes.reportePorAnimales, name='Reportes-Por-Animales'),
    # servidos
    path('Reporte-Movimientos-Servidos/', reportes.reporteServidosMovimientos, name='Reportes-Movimientos-Servidos'),
    path('Reporte-Servidos-Liquidacion/', reportes.reporteServidosLiquidacion, name='Reportes-Servidos-Liquidacion'),
     path('Reporte-Servidos-Promedio-Diario/', reportes.reporteServidosPromedio, name='Reportes-Servidos-Promedio'),
